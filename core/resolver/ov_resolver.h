...
/* ========================================================================= */
/* Phase 6 Unified Capability-Based Architecture Pipeline                    */
/* Hardware ↓ Capabilities ↓ Compatibility ↓ Profile ↓ Resolver ↓ Config     */
/* ========================================================================= */

typedef struct {
    const ov_hardware_profile_t     *hardware;
    const char                       *target_os;
    ov_perf_profile_id_t              perf_profile_id;
    ov_integrated_request_t           workload;
} ov_pipeline_request_t;

typedef struct {
    ov_resolution_result_t            workload_resolution;
    ov_compat_category_t              compat_category;
    char                              compat_category_str[64];
    bool                              is_real_hardware;
    char                              selected_backend[64];
    char                              selected_gpu_name[128];
    uint32_t                          selected_gpu_index;
    char                              boot_arguments[256];
    char                              efi_drivers_required[256];
    char                              overall_pipeline_summary[512];
} ov_pipeline_decision_t;
